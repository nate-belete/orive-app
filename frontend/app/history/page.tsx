...
import { useOccasions, useFeedback } from '@/lib/api/hooks'
      ...
      {occasions && occasions.length === 0 ? (
        <Card>
          <p className="text-gray-600 dark:text-gray-400">
            No occasions yet. <Link href="/occasions/new" className="text-blue-600 hover:underline">Create your first occasion</Link>.
          </p>
        </Card>
      ) : (
