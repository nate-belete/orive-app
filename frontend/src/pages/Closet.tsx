...
import { useClosetItems, useCreateClosetItem, useDeleteClosetItem } from '../api/hooks'
import Card from '../components/Card'
import FormField from '../components/FormField'
import Loading from '../components/Loading'
import ErrorState from '../components/ErrorState'
import type { ClosetItemCreate } from '../api/types'
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div>
          <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Items ({items?.length || 0})</h2>
          {items && items.length === 0 ? (
            <Card>
              <p className="text-gray-600 dark:text-gray-400">No items in your closet yet. Add your first item!</p>
            </Card>
          ) : (
